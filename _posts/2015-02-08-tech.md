...
&nbsp&nbsp// Ready state 4 means the request is done<br>
&nbsp&nbspif(xhr.readyState === 4){<br>
&nbsp&nbsp&nbsp&nbsp// 200 is a successful return<br>
&nbsp&nbsp&nbsp&nbspif(xhr.status === 200){<br>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbspalert(xhr.responseText); // 'This is the returned text.'<br>
&nbsp&nbsp&nbsp&nbsp}else{<br>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbspalert('Error: '+xhr.status); // An error occurred during the request<br>
